...
class CigMetricsAlignmentVgTest(unittest.TestCase):
    ...
    def test_parse(self):
        from cig.metrics.alignment.parser.vg import parse
    ...
    def test_parse_events(self):
        from cig.metrics.alignment.parser.vg import parse_events
    ...
    def test_parse_multi(self):
        from cig.metrics.alignment.parser.vg import parse_multi

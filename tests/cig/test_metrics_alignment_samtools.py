...
class CigMetricsAlignmentSamtoolsTest(unittest.TestCase):
    ...
    def test_parse(self):
        from cig.metrics.alignment.samtools import parse
    ...
    def test_parse_SN(self):
        from cig.metrics.alignment.samtools import parse_SN_line
    ...
    def test_parse_RL(self):
        from cig.metrics.alignment.samtools import parse_RL_line

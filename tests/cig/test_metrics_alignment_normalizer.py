...
class MetricsAlignmentNormalizerTest(unittest.TestCase):
    ...
    def test_normalize(self):
        ...
        expected = {"total": 234250490, "aligned": 231187217, "unmapped": 3063273, "paired": 0, "secondary": 0, "quality mean": 34.8, "aligned pct": 0.9869, "paired pct": 0.0, "secondary pct": 0.0, "unmapped pct": 0.0131,}

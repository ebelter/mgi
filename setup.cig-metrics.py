...
setup(
    ...
    packages=find_packages(include=["cig", "cig.metrics", "cig.metrics.alignment", "cig.metrics.alignment.parser", "cig.metrics.rnaseq", "cig.metrics.seqlendist"], exclude=("tests")),
)
